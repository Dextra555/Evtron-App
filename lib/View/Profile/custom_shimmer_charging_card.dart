...
class CustomShimmerChargingCard extends StatelessWidget {
  const CustomShimmerChargingCard({super.key});
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    // Static Invoice button - no shimmer
                    Container(
